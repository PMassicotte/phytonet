...
from .inference import predict_image, batch_predict
...
def predict_cli():
    ...
    try:
        ...
        print("Please provide --classes-path or ensure the .json file exists alongside the model")
        return
